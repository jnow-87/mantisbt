...
$t_bug_link = format_link(bug_format_id($t_bug_id), helper_mantis_url('bug_page.php'), array('id' => $t_bug_id, '#tab_0' => ''));
$t_reload_link = ($f_master_bug_id > 0 ? format_link('Reload', helper_mantis_url('bug_page.php'), array('id' => $f_master_bug_id, '#tab_0' => '')) : '');
