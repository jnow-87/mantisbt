...
page_title('User Management');
	...
	table_begin(array('', 'User Name', 'Real Name', 'eMail', 'Access Level', 'Enabled', 'Protected', 'Date Created', 'Last Visited'), 'table-condensed table-hover table-sortable no-border', '', array('width="40px"'));
